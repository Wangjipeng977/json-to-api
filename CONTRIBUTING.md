# Contributing to `User Provides Json`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/User Provides Json.git
cd User Provides Json
...
git add .
git commit -m "feat(json-to-api): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(json-to-api): add <brief description>
